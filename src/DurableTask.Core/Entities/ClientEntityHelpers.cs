...
public static class ClientEntityHelpers
{
    ...
    public static string? GetEntityState(string? serializedSchedulerState)
    {
        ...
        var schedulerState = JsonSerializer.Deserialize<SchedulerState>(serializedSchedulerState, Serializer.InternalSerializerOptions)!;
    ...
    public static EntityStatus? GetEntityStatus(string? orchestrationCustomStatus)
    {
        ...
        return JsonSerializer.Deserialize<EntityStatus>(orchestrationCustomStatus, Serializer.InternalSerializerOptions)!;
    }
}